...
isStyles.textContent = `
  ...
  .is-text code {
    ...
    font-family: "JetBrains Mono", monospace; font-size: 0.78rem; color: #5b8af5;
  }
  ...
  .is-step-num {
    flex: 0 0 28px; height: 28px; background: #5b8af5;
  ...
  .is-step-body code {
    background: #1a1d23; padding: 2px 6px; border-radius: 4px;
    font-family: "JetBrains Mono", monospace; font-size: 0.72rem; color: #5b8af5;
  }
  .is-timers {
  ...
  .is-timer-value { flex: 0 0 80px; color: #5b8af5; font-family: "JetBrains Mono", monospace; font-size: 0.78rem; }
