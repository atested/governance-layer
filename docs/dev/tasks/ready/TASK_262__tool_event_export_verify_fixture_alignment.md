# TASK_262 — Tool-event export/verify fixture alignment

SPEC_EXPECTED: CODE

## Intent
Extend shared export/verify fixture/helpers or conventions only as needed to support the completed output-alignment and shape-consistency cases without duplicated setup.
...
- Scope remains bounded to existing tool-event export/verify surfaces and tests.

## Files allowed to touch
- system/tests/**
- scripts/attest/export_tool_event_bundle.py
- scripts/attest/verify_tool_event_bundle.py
- docs/dev/evidence/TASK_262/**
...
- docs/dev/evidence/TASK_262/TESTS.txt
- docs/dev/evidence/TASK_262/DIFF_NAME_ONLY.txt
- docs/dev/evidence/TASK_262/DIFF_STAT.txt
- docs/dev/evidence/TASK_262/HOTFILE_SCAN.txt
