# TASK_255 — Attestation export negative follow-on

SPEC_EXPECTED: CODE

## Intent
Complete remaining malformed-input, missing-artifact, and mismatch negative-path coverage for current-main attestation/proof export behavior. Keep scope bounded to existing merged export behavior and tests.

## Acceptance criteria
- Deterministic malformed-input, missing-artifact, and mismatch behavior across touched export-side surfaces.
...
- docs/dev/evidence/TASK_255/TESTS.txt
- docs/dev/evidence/TASK_255/DIFF_NAME_ONLY.txt
- docs/dev/evidence/TASK_255/DIFF_STAT.txt
- docs/dev/evidence/TASK_255/HOTFILE_SCAN.txt

## Determinism expectations
- Stable malformed/missing-artifact/mismatch behavior for touched export-side surfaces.
