# TASK_138__github_actions_ci_release_gate_and_proof_bundle_artifacts.md

TASK_ID: TASK_138
Title: [External usability] GitHub Actions CI workflow for release-gate + proof bundle artifacts
Executor: Codex
Owner/Gate: Greg
Branch: codex/TASK_138
Status: Ready
Dependencies: TASK_135, TASK_136
Bucket: External usability

## Goal
Add a minimal GitHub Actions workflow that runs release-gate and uploads proof-bundle artifacts.
...
- docs/dev/evidence/TASK_138/**
- tests/test_github_actions_release_gate_workflow.sh
...
- Updates `docs/dev/evidence/TASK_138/TESTS.txt` with commands and `[exit=...]` markers.
...
## Evidence required
- docs/dev/evidence/TASK_138/TESTS.txt
