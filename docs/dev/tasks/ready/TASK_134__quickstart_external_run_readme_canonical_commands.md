# TASK_134__quickstart_external_run_readme_canonical_commands.md

TASK_ID: TASK_134
Title: [External usability] Quickstart external run: canonical commands + outputs
Executor: Cecil
Owner/Gate: Greg
Branch: codex/TASK_134
Status: Ready
Dependencies: none
Bucket: Docs / process (optional)

## Goal
Add a concise external-user quickstart showing canonical setup/run commands and where release-gate/proof-bundle outputs appear.
...
- Updates `docs/dev/evidence/TASK_134/TESTS.txt` with commands and `[exit=...]` markers.
...
## Evidence required
- docs/dev/evidence/TASK_134/TESTS.txt
