# TASK_269 — Tool-event helper contract alignment

SPEC_EXPECTED: CODE

## Intent
Align shared tool-event helper outputs and helper-call conventions where current-main tests still use inconsistent parsing or assertion shapes. Keep scope bounded to helper files and directly adjacent tests.

## Acceptance criteria
- Stable helper output/assertion conventions are used across touched tool-event export/verify tests.
...
- Scope remains bounded to tool-event helper and directly adjacent test/output surfaces.

## Files allowed to touch
- system/tests/helpers/**
- system/tests/**
- scripts/attest/**
- docs/dev/evidence/TASK_269/**
...
- docs/dev/evidence/TASK_269/TESTS.txt
- docs/dev/evidence/TASK_269/DIFF_NAME_ONLY.txt
- docs/dev/evidence/TASK_269/DIFF_STAT.txt
- docs/dev/evidence/TASK_269/HOTFILE_SCAN.txt
