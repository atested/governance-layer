# TASK_267 — Tool-catalog helper determinism alignment

SPEC_EXPECTED: CODE

## Intent
Standardize deterministic helper usage across current-main tool-catalog export/verify tests where equivalent cases still use divergent setup or hashing patterns. Keep scope bounded to existing merged helper/test behavior.

## Acceptance criteria
- Deterministic helper usage is aligned across touched tool-catalog export/verify tests.
...
- Scope remains bounded to existing tool-catalog helper/test behavior.

## Files allowed to touch
- system/tests/helpers/**
- system/tests/**
- scripts/attest/**
- docs/dev/evidence/TASK_267/**
...
- docs/dev/evidence/TASK_267/TESTS.txt
- docs/dev/evidence/TASK_267/DIFF_NAME_ONLY.txt
- docs/dev/evidence/TASK_267/DIFF_STAT.txt
- docs/dev/evidence/TASK_267/HOTFILE_SCAN.txt
