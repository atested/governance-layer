# TASK_268 — Tool-catalog helper duplication reduction

SPEC_EXPECTED: CODE

## Intent
Reduce duplicated setup/parsing logic across current-main tool-catalog tests only where shared helper extraction clearly lowers maintenance cost without broadening subsystem scope.

## Acceptance criteria
- Duplicate setup/parsing patterns across touched tool-catalog export/verify tests are reduced via shared helper logic.
...
- Scope remains bounded to existing tool-catalog helper and adjacent test surfaces.

## Files allowed to touch
- system/tests/helpers/**
- system/tests/**
- scripts/attest/**
- docs/dev/evidence/TASK_268/**
...
- docs/dev/evidence/TASK_268/TESTS.txt
- docs/dev/evidence/TASK_268/DIFF_NAME_ONLY.txt
- docs/dev/evidence/TASK_268/DIFF_STAT.txt
- docs/dev/evidence/TASK_268/HOTFILE_SCAN.txt
