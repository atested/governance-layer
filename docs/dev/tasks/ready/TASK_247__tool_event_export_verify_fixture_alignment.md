# TASK_247 — Tool-event export/verify fixture alignment

SPEC_EXPECTED: CODE

## Intent
Extend shared export/verify fixture helpers or conventions only as needed to support the completed negative-path matrix without duplicated setup.
...
- docs/dev/evidence/TASK_247/TESTS.txt
- docs/dev/evidence/TASK_247/DIFF_NAME_ONLY.txt
- docs/dev/evidence/TASK_247/DIFF_STAT.txt
- docs/dev/evidence/TASK_247/HOTFILE_SCAN.txt
