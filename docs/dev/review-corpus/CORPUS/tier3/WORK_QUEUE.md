...
Canonical current-main truth is presently `NEXT_WORKFRONT_FORMULATION`, not immediate bounded-tranche execution. The best immediate formulation candidate is post-traceability governance evidence product work; queue rows below must not be treated as overriding that canon outcome by mere `Ready` status.
