...
FIXTURE="$ROOT/tests/fixtures/fs_list_not_a_directory.json"

echo "--- TASK_093: RC-FS-NOT-A-DIRECTORY ---"
...
echo "$out" | grep -q 'RC-FS-NOT-A-DIRECTORY'

echo "PASS: decision DENY with RC-FS-NOT-A-DIRECTORY"
