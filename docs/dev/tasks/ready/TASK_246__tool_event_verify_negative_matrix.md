# TASK_246 — Tool-event verify negative matrix

SPEC_EXPECTED: CODE

## Intent
Complete malformed-input and mismatch negative-path coverage for current-main tool-event bundle verify behavior. Keep scope bounded to existing merged verify behavior and tests.

## Acceptance criteria
- Deterministic malformed-input and mismatch behavior across touched verify surfaces.
...
- docs/dev/evidence/TASK_246/TESTS.txt
- docs/dev/evidence/TASK_246/DIFF_NAME_ONLY.txt
- docs/dev/evidence/TASK_246/DIFF_STAT.txt
- docs/dev/evidence/TASK_246/HOTFILE_SCAN.txt

## Determinism expectations
- Stable malformed/mismatch output behavior for touched verify paths.
...
- STOP if scope drifts outside listed tool-event verify surfaces.
