...
fbStyles.textContent = `
  ...
  .fb-textarea:focus { outline: 2px solid #6699cc; outline-offset: 1px; }
  ...
  .fb-checkbox input { accent-color: #6699cc; }
  .fb-telemetry-controls { display: flex; align-items: center; gap: 12px; flex-wrap: wrap; }
  .fb-result-success { color: #3fb950; font-size: 0.82rem; margin-top: 6px; }
  .fb-result-error { color: #d29922; font-size: 0.82rem; margin-top: 6px; }
