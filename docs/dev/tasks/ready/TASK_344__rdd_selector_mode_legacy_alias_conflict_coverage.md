# TASK_344 — RDD: Selector-mode legacy-alias conflict coverage

SPEC_EXPECTED: CODE

## Intent
Add bounded deterministic coverage for legacy-only multi-alias selector-mode conflict handling so dual legacy alias declarations fail closed with stable markers while existing canonical and single-alias behaviors remain regression-safe.
...
- Required negative cases:
  ...
  - canonical absent + both legacy aliases fails closed with stable legacy-conflict marker.
...
- `docs/dev/evidence/RDD_PHASE13_SELECTOR_MODE_LEGACY_ALIAS_CONFLICT__v1/TASK_344/**`
...
- `docs/dev/evidence/RDD_PHASE13_SELECTOR_MODE_LEGACY_ALIAS_CONFLICT__v1/TASK_344/TESTS.txt`
- `docs/dev/evidence/RDD_PHASE13_SELECTOR_MODE_LEGACY_ALIAS_CONFLICT__v1/TASK_344/DIFF_NAME_ONLY.txt`
- `docs/dev/evidence/RDD_PHASE13_SELECTOR_MODE_LEGACY_ALIAS_CONFLICT__v1/TASK_344/DIFF_STAT.txt`
- `docs/dev/evidence/RDD_PHASE13_SELECTOR_MODE_LEGACY_ALIAS_CONFLICT__v1/TASK_344/HOTFILE_SCAN.txt`

## Determinism expectations
- Selector-mode source matrix output hash is stable across repeated runs with identical fixtures.
- Legacy-alias conflict fail-closed markers are deterministic and explicitly asserted.
...
## Constraints
- Coverage stays within bounded selector-mode legacy-alias conflict seam for the current v1 case class.
